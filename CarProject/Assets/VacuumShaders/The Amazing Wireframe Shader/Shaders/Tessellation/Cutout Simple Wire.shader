...
Shader "Hidden/VacuumShaders/The Amazing Wireframe/Tessellation/Cutout/Simple/Wire Only"
{
	Properties
	{
		//Tag         
		...
		SubShader
	{
		...
		"RenderType" = "Wireframe_WireOnly_Tessellation_TransparentCutout"
	}
		LOD 200
		Cull[_Cull]
...
#pragma target 5.0 
#pragma multi_compile_fog
#pragma multi_compile_fwdadd_fullshadows nolightmap nodynlightmap
#include "HLSLSupport.cginc"
#include "UnityShaderVariables.cginc"
		// Surface shader code generated based on:
		// vertex modifier: 'vert'
...
ENDCG
	...
	//Shadow
	UsePass "Hidden/VacuumShaders/The Amazing Wireframe/Tessellation/Shadow/Cutout/Wire Only/SHADOWCASTER"
