...
Shader "Hidden/VacuumShaders/The Amazing Wireframe/Geometry Shader/Transparent/ZWrite/Diffuse Improved"
{
	Properties
	{
		//Tag         
		...
		SubShader
	{
		...
		UsePass "Hidden/VacuumShaders/The Amazing Wireframe/ColorMask0 NoInstance/BASE"
